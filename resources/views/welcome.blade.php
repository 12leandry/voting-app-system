        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#contact">Vote Now</a></li>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>Bettter digital experience with </h1>
                    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error unde dolor ipsam, ratione nobis,
                        impedit architecto quidem quaerat quae minima laudantium vel in voluptatem repudiandae tenetur
                        dolore voluptatibus a alias.</h2>
                    <div>
